...
public class FuncionarioController {
	...
	public FuncionarioController(FuncionarioService _funcionarioService, GeneroService generoService, LivroService livroService) {
	...
	public String Acessar(ModelMap map, @RequestParam("email") String email, @RequestParam("senha") String senha,
		...
		if (funclogado != null) {
			...
			if (funclogado.getAcesso().equals("FUNC")) {
				return "redirect:/universoliterario/produtos/Estoque";
